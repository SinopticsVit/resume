#!/usr/bin/env python3
"""Generate DOCX for AI/LLM Engineer resume and cover letter."""
...
from generate_plata_risk_docx import convert_resume_md_to_docx, set_run_font, add_rich_text, NAVY

MD = HERE / "AI_LLM_Engineer_Kurnosenko_EN.md"
DOCX = HERE / "AI_LLM_Engineer_Kurnosenko_EN.docx"
COVER_MD = HERE / "Cover_Letter_AI_LLM_Engineer_Kurnosenko_EN.md"
COVER_DOCX = HERE / "Cover_Letter_AI_LLM_Engineer_Kurnosenko_EN.docx"
